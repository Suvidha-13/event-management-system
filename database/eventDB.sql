...
(2, 'Sample Audience', '9123456780', 'audience@sample.com', 'Sample', 1, 1, 0, 1, '0000-00-00 00:00:00');
...
(1, 'Event Management System', 'emssupport@gmail.com', '+919856742578', '1677500820_dj-audio-mixer-controller-mixing-electronic-music-nightclub-party-selective-focus-2d-illustration_67092-1841.avif', '&lt;p style=&quot;text-align: center; background: transparent; position: relative;&quot;&gt;&lt;span style=&quot;color: rgb(0, 0, 0); font-family: &amp;quot;Open Sans&amp;quot;, Arial, sans-serif; font-weight: 400; text-align: justify;&quot;&gt;&amp;nbsp;Our company specializes in providing an Event Management System that helps Event Organizing Companies manage their client events and market them. We also offer a list of possible venues for events, which can be displayed on our clients’ websites. Our system allows potential event attendees to register online through our clients&quot websites. The registration serves as a request until our system admin reaches out to confirm the registration and settle payments if necessary.<br><br>Our system also allows clients to inquire about desired event venues. On the management side, our dynamic venue list can be easily populated and managed by our staff to display venues on our clients&quot websites. Our system users can populate event details and descriptions for events that our clients are handling. Clients can choose to publish their events for potential attendee registration or store the event details for their reference.<br><br>Our system allows the storage of venue images, event banners, and other details that can help our clients market their events and venues. With our Event Management System, our clients can streamline their event planning process, reduce costs, and improve the attendee experience.&lt;/span&gt;&lt;br&gt;&lt;/p&gt;&lt;p style=&quot;text-align: center; background: transparent; position: relative;&quot;&gt;&lt;br&gt;&lt;/p&gt;&lt;p style=&quot;text-align: center; background: transparent; position: relative;&quot;&gt;&lt;br&gt;&lt;/p&gt;&lt;p&gt;&lt;/p&gt;');
...
(1, 'Sample Venue 1', 'Kompally, Hyderabad - 500014, Telangana, India', 'Rajkamal Palace is a premium European themed venue for weddings and social and corporate events near Kompally on the Outer Ring Road (ORR), Hyderabad. Rajkamal Palace is not only a unique place in Hyderabad, but also a distinctive property in India.', 300),
(2, 'Sample Venue 2', 'Karimnagar Highway Shamirpet, Medchal, Hyderabad', 'The venue location includes Italian gardens with a Roman themed pool and water fountains with European sculpture. The garden areas, which are done at four different levels, are designed to facilitate different groups for any event.', 250),
(3, 'Sample Venue 3', ' Lumbini Jewel Mall, Road No 2, Banjara Hills, Hyderabad, 500034', 'The venue has a kind of ambience which will definitely steal your gaze and make you fixated at their interior decor and infrastructure. The ambience style is contemporary with a touch of minimalism and sophistication.', 280),
(4, 'Sample Venue 4', 'Old Patigadda, Chikoti Gardens, Begumpet, Hyderabad', ' The venue has Outdoor spaces available which can accomodate up to 500 guests and hence a popular option for weddings in Hyderabad.', 1000);
...
(1, 'Suvidha', 'Hyderabad', 'suvi@gmail.com', '90907981314', 2, '1 night', '2023-10-14 17:00:00', 1);
